...
public class InvoiceGenerator {
    public static void createInovice (ByteArrayOutputStream baos, Invoice invoice){
        ...
        try {
            ...
            irhTable.addCell(getIRHCell("", PdfPCell.ALIGN_RIGHT));
            irhTable.addCell(getIRHCell("Fattura Ordine N°"+String.format("%08d", invoice.getBookID()), PdfPCell.ALIGN_RIGHT));
            irhTable.addCell(getIRHCell("", PdfPCell.ALIGN_RIGHT));
            irhTable.addCell(getIRHCell("", PdfPCell.ALIGN_RIGHT));
            ...
            document.addTitle("Fattura ordine "+String.format("%08d", invoice.getBookID()));
